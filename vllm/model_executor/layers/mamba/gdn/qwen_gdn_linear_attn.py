...
class QwenGatedDeltaNetAttention(GatedDeltaNetAttention):
    def get_state_shape(
        ...
        if self.cache_config.use_flashssm_spec:
            return MambaStateShapeCalculator.gated_delta_net_spec_cached_state_shape(
                ...
                self.cache_config.flashssm_buffer_len,
                self.num_spec,
            )
    ...
    def __init__(
        ...
        # decodes through fused_recurrent_gated_delta_rule_flashssm_decode.
        self.use_cache_kernel = self.cache_config.use_flashssm
        self.max_cache_len = self.cache_config.flashssm_buffer_len
        # Cached-SPEC decode kernel (gdn_flashssm_spec_decode); see
