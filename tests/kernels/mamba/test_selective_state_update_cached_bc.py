...
from tests.kernels.mamba.utils import (
    ...
    selective_state_update_cached_bc_ref,
)
...
def test_selective_state_update_cached_bc_matches_baseline_decode(
    max_cache_len: int,
    dstate: int,
    ngroups: int,
    has_z: bool,
    ...
    for _ in range(num_steps):
        ...
        out_ref = selective_state_update_cached_bc_ref(
            state_ref,
            x,
            dt,
            A,
...
def test_selective_state_update_cached_bc_with_batch_indices(
    with_padding: bool,
    itype: torch.dtype,
):
    device = "cuda"
